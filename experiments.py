...
if __name__ == "__main__": 
    ...
    rho, theta, u = limiirl(X=X, taus=taus, features=features, M=cluster_model, states=states, f=f, transition=p_transition, epsilon=0.001, max_iter=max_iterations, K=K, descent_iter=descent_iter, run_EM=(start == "yes"))
